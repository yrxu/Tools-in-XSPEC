...
p4=['v',0,np.median(v_vals),0.01,min(v_vals),min(v_vals),max(v_vals),max(v_vals),len(v_vals),v_array]
p5=['fcov',0,1,0.01,0,0,1,1,len(fcov_vals),fcov_array]
